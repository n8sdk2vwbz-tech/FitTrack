    ...
    private var components: [Component] {
        [
            ...
            Component(
                ...
                rawValue: nil,
                explanation: "Volumen und wahrgenommene Anstrengung (RPE und/oder Trainings-Herzfrequenz) der letzten Einheit, verglichen mit deinem eigenen typischen Volumen (Median der letzten Einheiten) - sobald mindestens 5 frühere Einheiten vorliegen, sonst gegen einen allgemeinen Richtwert. So zählt eine für DICH harte Einheit auch dann als belastend, wenn du grundsätzlich mit geringerem Gewicht trainierst. Klingt über ca. 4 Tage auf neutral ab, falls seitdem keine neue Einheit protokolliert wurde. Die Herzfrequenz wird dabei nach Möglichkeit relativ zu deiner geschätzten HFmax bewertet (aus deinem in Health hinterlegten Geburtsdatum), sonst gegen einen festen Richtwert. Ab der 10. Einheit kommt zusätzlich die langfristige Belastung (Verhältnis aus kurz- zu langfristiger Trainingslast, ACWR) über die letzten Wochen dazu. Das Gewicht steigt zusätzlich auf bis zu 55 %, je frischer die letzte Einheit ist: Schlaf/HRV/Ruhepuls spiegeln nur deinen Zustand vor dieser Einheit wider und können ein gerade erst absolviertes Training noch nicht erfassen.",
