...
public enum ExerciseLibrary {
    ...
    public static let all: [Exercise] = [
        ...
        Exercise(id: "one-arm-dumbbell-row", name: "Kurzhantel Rudern einarmig", category: .strength, equipment: .dumbbell, primaryMuscles: [.upperBack, .lats], secondaryMuscles: [.biceps], instructions: "Auf Bank abstützen, Kurzhantel seitlich zur Hüfte ziehen."),
        ...
        Exercise(id: "overhead-triceps-extension", name: "Overhead Extension", category: .strength, equipment: .dumbbell, primaryMuscles: [.triceps], secondaryMuscles: [], instructions: "Kurzhantel hinter dem Kopf absenken und wieder strecken."),
